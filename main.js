function goStepTwo() {
  ...
  checkBox = document
    ...
    .addEventListener("click", event => {
      ...
      anneeAdvanced.style.backgroundColor = "white";
      anneeAdvanced.style.border = " solid 1px hsl(229, 24%, 87%)";
  ...
  function checkNum() {
    ...
    } else if (myNumInput.value.trim().length !== 11) {
      myNumError.innerHTML = "Invalid Phone Number and Please make sure your number is up to 11 digits";
    } else {
  ...
  function Achieve() {
    ...
    if (
      myNumInput.value.trim().length === 11 &&
